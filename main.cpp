...
case 8: {
    ...
    cout << "3 - Strategija 3 (stable_partition su rikiavimu pagal balus)\n";
    ...
    cout << "Vykdoma strategija 3 (optimizuota su partition ir sort)\n";
    ...
    for (auto n : sizes) {
        string fail_name = "studentai_" + to_string(n) + ".txt";
        strategija3_optimizuota(fail_name, n);
    }
    }
    else {
